...
use App\Nova\Templates\GolfTemplate;
...
Route::get('golffreunde', [PageController::class, 'golffreunde'])->template(GolfTemplate::class)->name('golffreunde');
...
Route::post('kontakt/senden', [ContactController::class, 'send'])
    ->name('kontakt.send');
Route::post('golf/kontakt/senden', [ContactController::class, 'golfContactForm'])
    ->name('golf.kontakt.send');
